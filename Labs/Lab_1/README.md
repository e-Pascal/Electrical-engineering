...
2.  Измерить напряжение холостого хода $U_{хх}$ на выходе активного двухполюсника. Рассчитать мощность. Результат зафиксировать в таблице в рабочей тетради (форма приведена в `таблице 2`);
