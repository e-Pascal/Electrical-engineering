...
4.  Рассчитать внутреннее сопротивление активного двухполюсника по формуле:

```math
R_0=\frac{U{xx}}{I_{кз}}
```

Результат зафиксировать в таблице в рабочей тетради, форма приведена в [шаблоне](./templates/template_1.docx);
