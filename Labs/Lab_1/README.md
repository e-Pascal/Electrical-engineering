...
### Задача 1. Вычислить значения токов I1 и I2, протекающих через резисторы R1 и R2 соответственно. Рассчитать напряжения U1 и U2 на резисторах R1 и R2 соответственно.
