...
2.  Получить дополнительные значения токов равные I_1=0.5*Iсог и I2=1.5*Iсог, изменяя сопротивление нагрузки $R_н$. Рассчитать мощность $P_1$ и $P_2$. Собрать электрические схемы. Результат зафиксировать в таблице в рабочей тетради, форма приведена в [шаблоне](./templates/template_1.docx);
