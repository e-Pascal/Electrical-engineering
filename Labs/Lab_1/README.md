...
2.  Измерить напряжение холостого хода $U_{хх}$ на выходе активного двухполюсника. Рассчитать мощность. Результат зафиксировать в таблице в рабочей тетради, форма приведена в [шаблоне](./Lab_1/templates/template_1.pdf);
...
2.  Получить дополнительные значения токов равные $I=0.5*I_{сог}$ и $I=1.5*I_{сог}$ , изменяя сопротивление нагрузки $R$. Заполнить таблицу для данных режимов работы;
