...
- [x] **Задание №1**
- [x] 1.1 Зафиксировать в тетради параметры для схемы ФВЧ из индивидуального задания и выполнить расчёт ёмкости $C_2$
- [x] 1.2 Зарисовать в тетради схему ФВЧ
- [x] 1.3 Зарисовать в тетради ЛАЧХ и ЛФЧХ для ФВЧ
- [x] 1.4 Построить модель схемы ФВЧ в MultiSim  (в отчёте зарисовать схему ФВЧ и подключение плоттера Боде к схеме)
- [x] 1.5 Зафиксировать в тетради частоту, соответствующую уровню -3 дБ на ЛАЧХ, отображаемой плоттером Боде
- [x] **Вывод**
