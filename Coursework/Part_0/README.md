...
Компонент представлен в версиях с фиксированным выходным напряжением (3,3 В, 5 В, 12 В, 15 В) и с регулируемым. Последние могут формировать уровень напряжения в диапазоне от 1,23 В до 60 В (HV версия). Разберем расчет LM2575(HV)-ADJ c регулируемым выходом, Uвых которого зависит от коэффициента обратной связи.
...
<p align="center" >Рисунок 3 – Подключение преобразователя с регулируемым выходом </p> 
...
По схеме из спецификации (по оси X - максимальный ток нагрузки, Y - константа индуктивности) на Рисунке 4 определим необходимый регион индуктивности и воспользуемся данными на Рисунке 5 для определения номинала катушки.

<p align="center" > <img src="./pic/l.jpg"></p>

<p align="center" >Рисунок 4 – Выбор области для катушки индуктивности </p> 

<p align="center" > <img src="./pic/ltab2.jpg"></p>

<p align="center" >Рисунок 5 – Выбор номинала катушки индуктивности </p> 
...
<p align="center" >Рисунок 6 – Выбор диода Шоттки </p> 
...
Изобразим подключенную схему согласно спецификации (Рисунок 3) в `САПР Altium Designer`:

<p align="center" > <img src="./pic/e31.jpg"></p>

<p align="center" >Рисунок 7 – LM2575 с компонентами обвязки </p> 
