# Методическая рекомендация по расчету импульсного преобразователя напряжения
...
В рамках данной курсовой работы вам предстоит произвести расчеты импульсника для формирования необходимого уровня напряжения для питания схемы. В качестве примера рассмотрим понижающий DC-DC преобразователь серии LM2575. [Cпецификация LM2575](https://static.chipdip.ru/lib/927/DOC012927213.pdf)
...
Для начала надо определиться, в каком именно корпусе будет наш импульсник (в спецификации предлагается 5 вариантов). Остановим наш выбор на компоненте в корпусе TO-220. Функционал, который в нем реализован, нам прекрасно подходит.

<p align="center" > <img src="./pic/to220.jpeg"></p>
