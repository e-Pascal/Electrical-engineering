...
Для начала необходимо определиться, в каком именно корпусе будет наш импульсник (в спецификации предлагается 5 вариантов). Остановим наш выбор на компоненте в корпусе TO-220. Функционал, который в нем реализован, нам прекрасно подходит.
