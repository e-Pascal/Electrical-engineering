...
Рассчитать и зарисовать схему электрическую принципиальную с учётом выбранного $U_{out}$ с учётом требований перечня ГОСТов, приведённого в приложении А. Номиналы сопротивления резисторов выбирать в соответствии с [рядом E96](./../appendix_D/README.md) и ёмкость конденсаторов с [ряда E24](./../appendix_D/README.md).
