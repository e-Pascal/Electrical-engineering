...
1. [Введение](#введение)
2. [Теоретическая база. ПИТАНИЕ](#теоретическая-база-питание)
...
3. [Теоретическая база. ТАКТИРОВАНИЕ](#теоретическая-база-тактирование)
   - [1. Генераторы и резонаторы](#1-генераторы-и-резонаторы)
   - [2. Тактирование микроконтроллеров](#2-тактирование-микроконтроллеров)
   - [3. Тактирование ПЛИС](#3-тактирование-плис)
4. [Теоретическая база. ИНТЕРФЕЙСЫ](#теоретическая-база-интерфейсы)
   ...
   - [Служебные выводы](#служебные-выводы)
5. [Задание](#задание)
...
<p align="center" >Рисунок – Пример использования супервизора для питания ПЛИС</p>
...
<p align="center" >Рисунок – Пример подключения ПЛИС</p>
...
<p align="center">Рисунок 4 – Управляющие сигналы для выбора режима загрузки</p>

---

#### Режимы загрузки для ПЛИС
