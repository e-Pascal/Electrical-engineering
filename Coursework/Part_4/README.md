...
- **PCI Local Bus Specification Revision 3.0** — Официальная спецификация PCI 3.0.  
...
- **PCI Express Base Specification Revision 6.0** — Официальная спецификация PCIe 6.0.  
