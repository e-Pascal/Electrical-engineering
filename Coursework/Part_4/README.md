...
1. Выбрать из предложенного по варианту семейства микросхему МК и ПЛИС (для КР можно выбрать корпус с минимальным количяеством выводов)
...
4. Выбрать линейные и линейные стабилизаторы для организации питания
5. Разработать схему Э3
   - тактирование МК от внешнего резонатора
   - такирование ПЛИС от внешнего генератора
   - наличие схемы сброса, фильтрации питания, схемы режима загрузки
   - подключение датичка и дисплея к соответствующим выводам МК, дополнительно по одной кнопке, светодиоду и движковому переключателю (свитчу)
