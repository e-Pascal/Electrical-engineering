...
Разработать схему Э3 на базе МК и ОУ. В отчёт по 4 части включить краткое описание характеристик МК, ОУ, микросхем для организации вторичного питания, а также приложение со схемой.
...
6. Разработать схему Э3 с учётом следующих требований:
   ...
   - выход ОУ подключить к контактному полю с полями "Выход ОУ", "GND".
