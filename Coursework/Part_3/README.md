...
<p align="center" >Рисунок 3.2 – Предлагаемая схема формирования питания</p>
...
7.	Итоговая схема формирования питания с учётом выбранных компонентов (образец оформления на Рис.3.3). К схеме необходимо приложить комментарии с расчётами пассивных компонентов. Для расчёта использовать [ряд E96](https://github.com/e-Pascal/Electrical-engineering/tree/main/Coursework/appendix_D) 
