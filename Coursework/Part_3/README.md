...
7.	Итоговая схема формирования питания с учётом выбранных компонентов (образец оформления на Рис.3.3). К схеме необходимо приложить комментарии с расчётами пассивных компонентов. Для расчёта использовать [ряд E96](./../appendix_D/README.md) 
