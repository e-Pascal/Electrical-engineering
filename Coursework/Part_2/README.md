...
```
Используя номинальный [ряд E24](https://github.com/e-Pascal/Electrical-engineering/tree/main/Coursework/appendix_D), $R_{2}\ = 12\ кОм$.
...
|-------|---------------|---------------|-----------|-----------|-------------------|  
|   1   |   6           |   10           |3\,5       |200        |Texas Instruments |
|   2   |   5\,5        |   10           |3\,5       |200        |Texas Instruments |
|   3   |   7           |   11           |3\,5       |200        | Analog Devices    |
|   4   |   6\,5        |   10           |3\,5       |250        | Analog Devices    |
|   5   |   8           |   11          |5          |320        |Texas Instruments |
|   6   |   7\,5        |   12           |5          |380        |Texas Instruments |
|   7   |   9           |   13          |5          |350        | Analog Devices    |
|   8   |   8\,5        |   14          |6          |330        | Analog Devices    |
|   9   |   10           |   14          |6          |250        |Texas Instruments |
|   10  |   9\,5        |   15          |6          |330        |Texas Instruments |
|   11  |   11          |   15          |6          |420        | Analog Devices    |
|   12  |   10\,5       |   14          |6          |430        | Analog Devices    |
|   13  |   11          |   15          |7          |415        |Texas Instruments |
|   14  |   10          |   12          |7          |430        |Texas Instruments |
|   15  |   11\,5       |   14          |7          |410        | Analog Devices    |
|   16  |   12          |   15          |7          |480        | Analog Devices    |
|   17  |   12\,5       |   17          |6          |410        |Texas Instruments |
|   18  |   13          |   17          |6          |470        |Texas Instruments |
|   19  |   13\,5       |   19          |7          |480        | Analog Devices    |
|   20  |   14          |   19          |6          |390        | Analog Devices    |
|   21  |   15\,5       |   18          |9          |290        |Texas Instruments |
|   22  |   14          |   18          |7          |380        |Texas Instruments |
|   23  |   14\,5       |   18          |8          |315        | Analog Devices    |
|   24  |   15          |   19          |8          |350        | Analog Devices    |
|   25  |   15\,5       |   18          |9         |350        |Texas Instruments |
|   26  |   16          |   19          |12         |300        |Texas Instruments |
|   27  |   16\,5       |   20          |11         |310        | Analog Devices    |
|   28  |   17          |   21          |11         |310        | Analog Devices    |
|   29  |   16\,5       |   21          |12         |320        |Texas Instruments |
|   30  |   17          |   21          |13         |450        |Texas Instruments |
...
Рассчитать схему для преобразователя в соответствии со спецификацией на выбранный компонент. Расчёт схемы включает в себя расчёт номиналов резисторов, конденсаторов и прочих пассивных компонентов (если они требуются в схеме) в соответствии со спецификацией на выбранный компонент. После вычисления точных значений номиналов подобрать ближайшие из [ряда E24](https://github.com/e-Pascal/Electrical-engineering/tree/main/Coursework/appendix_D) (при дальнейших расчётах использовать номиналы именно этого ряда).  Рассчитать абсолютное и относительное отклонение $U_{out}$ от $U_{out\ nom}$ в результате применения компонентов из ряда E24.
...
|-------|---------------|---------------|--------------|--------------|-------------------|  
|   1   |   14\.5       |   16          |   5          |    10        |Texas Instruments |
|   2   |   15          |   18          |   3\,3       |    15        |Texas Instruments |
|   3   |   15\,5       |   17          |   5          |    11        | Analog Devices    |
|   4   |   8\,5        |   12          |   3\,3       |    9         | Analog Devices    |
|   5   |   9           |   12          |   5          |    9         |Texas Instruments |
|   6   |   9\,5        |   14          |   3\,3       |    8         |Texas Instruments |
|   7   |   10          |   13          |   5          |    19        | Analog Devices    |
|   8   |   10\,5       |   13          |   3\,3       |    14        | Analog Devices    |
|   9   |   11          |   16          |   5          |    14        |Texas Instruments |
|   10  |   11\,5       |   14          |   3\,3       |    15        |Texas Instruments |
|   11  |   12          |   15          |   5          |    11        | Analog Devices    |
|   12  |   12\,5       |   16          |   3\,3       |    9         | Analog Devices    |
|   13  |   13          |   17          |   5          |    8         |Texas Instruments |
|   14  |   13          |   15          |   5          |    11        |Texas Instruments |
|   15  |   13\,5       |   17          |   3\,3       |    15        | Analog Devices    |
|   16  |   14          |   17          |   5          |    11        | Analog Devices    |
|   17  |   14\,5       |   17          |   3\,3       |    9         |Texas Instruments |
|   18  |   15          |   17          |   5          |    15        |Texas Instruments |
|   19  |   15\,5       |   19          |   3\,3       |    21        | Analog Devices    |
|   20  |   16          |   19          |   5          |    11        | Analog Devices    |
|   21  |   16\,5       |   19          |   3\,3       |    14        |Texas Instruments |
|   22  |   17          |   19          |   5          |    9         |Texas Instruments |
|   23  |   17\,5       |   19          |   3\,3       |    13        | Analog Devices    |
|   24  |   18          |   19          |   5          |    8         | Analog Devices    |
|   25  |   18\,5       |   20          |   3\,3       |    14        |Texas Instruments |
|   26  |   19          |   20          |   5          |    17        |Texas Instruments |
|   27  |   12\,5       |   19          |   3\,3       |    11        | Analog Devices    |
|   28  |   13          |   18          |   5          |    6         | Analog Devices    |
|   29  |   13\,5       |   17          |   3\,3       |    12        |Texas Instruments |
|   30  |   14          |   17          |   5          |    11        |Texas Instruments |
...
$U_{in\ max}$ – максимальное входное напряжение схемы формирования питания  
$U_{out\ nom}$ – номинальное выходное напряжение схемы формирования питания  
$R_{нагр}\ ,\ Ом$ – сопротивление нагрузки  
