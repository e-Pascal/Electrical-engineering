...
Очевидно при таком соединении один из источников генерирует энергию, а другой потребляет. Обозначив направления токов и напряжений в схемах, становится ясно, что для схемы рис. а) в источнике ЭДС $\rho=ui>0$ - потребитель, а в источнике тока $\rho=ui<0$ю
