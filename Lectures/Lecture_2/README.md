...
Если ток через источник протекает согласно с направлением внутренних сил, то $p=ui<0$ .
...
3. `Катушка индуктивности` (рис. 2-6) элемент, обладающий только свойством накапливать (и отдавать) энергию магнитного поля.
...
4. `Конденсатором` называют емкостный элемент, который обладает свойством только запасать энергию электрического поля (рис. 2-7)
...
Как видно из вольт-амперной характеристики в режиме холостого хода $U_{XX}=\theta$  и в режиме короткого замыкания $i_{КЗ}=J$ .
